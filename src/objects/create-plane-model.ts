...
/**
 * A small high-wing aircraft, nose pointing down -Z so lookAt() along its path orients it
 * correctly. Only ever seen at distance and against the sky, so it is built from the
 * silhouette cues that read at that range and nothing else.
 */
